package com.csja.smlocked.push.example;
...
public class MyPushMessageReceiver extends PushMessageReceiver {
    ...
    public void onBind(Context context, int errorCode, String appid,
        ...
        String responseString = "onBind errorCode=" + errorCode + " appid="
                ...
                + " requestId=" + requestId;
        MLog.i(TAG, responseString);

        if (errorCode == 0) {
            // 绑定成功
            MLog.i(TAG, "绑定成功");
            Constant.saveChannelId(context, channelId);
        }
...
//        updateContent(context, responseString);
    ...
    public void onMessage(Context context, String message,
        ...
        if (TextUtils.isEmpty(Constant.getStudentInfo(context))) {
            return;
        }
        ...
        try {
            ...
            NotifyMessageController.bindTimeConfig(context, jsonObject.optString("custom_content"));
        ...
        if (!TextUtils.isEmpty(customContentString)) {
            ...
            try {
                ...
                if (!customJson.isNull("type")) {
                    ...
                    if (type == 1) {//家长绑定
                        NotifyMessageController.bindParent(context, title,
