...
public class ViewFinderView extends View implements IViewFinder {
    ...
    private void init() {
        mDefaultLaserColor = getResources().getColor(R.color.viewfinder_laser);
        mDefaultMaskColor = getResources().getColor(R.color.viewfinder_mask);
        mDefaultBorderColor = getResources().getColor(R.color.viewfinder_border);
        mDefaultBorderStrokeWidth = getResources().getInteger(R.integer.viewfinder_border_width);
